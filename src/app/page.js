    ...
    <main className="flex bg-stone-50 min-h-screen flex-col items-center justify-between px-1">
      <navbar className=" w-full px-2 pt-1 pb-1 flex justify-between items-center">
        <div className="nav-logo w-[80px] h-[60px] sm:w-[100px] sm:h-[80px] md:w-[130px] md:h-[100px]">
          ...
          <img
            loading="lazy"
            src="/oficial/Gastify-full-black.PNG"
            className="w-full h-full"
          />
            </Link>
        </div>
        <div className="nav-elements flex gap-6 text-purple-900">
          <Link
            href="/register"
            className="text-base leading-8 uppercase items-stretch hover:text-purple-700"
          >
            Register me
          </Link>
          <Link
