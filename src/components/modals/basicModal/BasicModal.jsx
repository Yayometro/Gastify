...
function BasicModal({ close, renderContent, renderBodyContent, renderHeader, zIndexClass = "z-[1000]" }) {
  ...
  return (
    <div className={`fixed w-screen h-screen top-0 left-0 flex justify-center items-center ${zIndexClass} overflow-x-hidden`}>
      ...
      ></div>
      {renderContent || (
        <div className="content absolute bg-slate-100 border-2 border-purple-600 flex flex-col w-full h-full max-w-[500px] max-h-[90%] rounded-2xl items-center justify-center overflow-hidden z-[1001]">
          {renderHeader}
          {renderBodyContent}
