...
function RenderTransactionsInModal({ data }) {
  ...
  return (
    <div className={`w-full h-full overflow-y-scroll bg-gf-surface-2 mb-[10px]`}>
      <header className="pt-2 w-full h-fit flex flex-col justify-between items-center bg-purple-600 text-white sticky top-0 z-10">
        ...
        <div className="footer-eader w-full h-3 rounded-t-3xl bg-gf-surface-2 mt-4"></div>
      </header>
      <section className="w-full h-full bg-gf-surface-2 flex flex-col items-center gap-1">
