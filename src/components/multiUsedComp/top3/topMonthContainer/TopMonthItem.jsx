        ...
        {!childs || childs.length <= 0
          ...
          : childs.map((item, i) => (
              <AtomicTop
                ...
                fatherStyle={`tra-cat-cont flex flex-col relative justify-center gap-1 items-center flex-1 rounded-3xl p-2 hover:mix-blend-multiply min-h-[130px] min-w-[100px] ${item?.color ? "" : "brightness-90"}`}
                tooltip={
