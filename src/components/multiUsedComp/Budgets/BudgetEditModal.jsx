...
function BudgetEditForm({ mode, budget, onClose }) {
  ...
  return (
    <BasicModal
      close={onClose}
      renderContent={
        <div className="content absolute bg-purple-600 border-2 border-purple-600 flex flex-col w-[350px] max-h-[90vh] overflow-y-auto rounded-2xl items-center pt-[40px] pb-6 z-[1001]">
          <div
